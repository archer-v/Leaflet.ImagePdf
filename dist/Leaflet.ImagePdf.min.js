...
/* harmony export */   "areaRectanglesCount": () => (/* binding */ areaRectanglesCount),
/* harmony export */   "coverAreaWithRectangles": () => (/* binding */ coverAreaWithRectangles),
/* harmony export */   "coverLineWithRectangles": () => (/* binding */ coverLineWithRectangles)
/* harmony export */ });
/**
 ...
 */
function resizeImage(imageBlob, newWidth, newHeight) {
...
/***/ "jspdf":
/*!***************************************************!*\
  !*** external {"commonjs":"jspdf","amd":"jspdf"} ***!
  \***************************************************/
/***/ ((module) => {
...
(() => {
/*!************************************!*\
  !*** ./src/js/Leaflet.ImagePdf.js ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OpCreatePage": () => (/* binding */ OpCreatePage),
/* harmony export */   "OpGenerateImage": () => (/* binding */ OpGenerateImage),
/* harmony export */   "OpLoadTiles": () => (/* binding */ OpLoadTiles)
/* harmony export */ });
...
/* harmony import */ var _covering_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./covering.js */ "./src/js/covering.js");
/* harmony import */ var _image_processing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./image-processing */ "./src/js/image-processing.js");
/* harmony import */ var changedpi__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! changedpi */ "./node_modules/changedpi/dist/index.js");
/**
 *      Leaflet.ImagePdf <https://github.com/mandalorian-one/Leaflet.ImagePdf>
 *
 *      MIT License http://www.opensource.org/licenses/mit-license.php
...
const OpGenerateImage = "image";
const OpCreatePage = "page";
const OpLoadTiles = "tile";
let progressSplashScreenDefaultStyle = {
  width: "100vw",
  height: "100vh",
  background: "white",
  "z-index": 950,
...
L.Control.ImagePdf = L.Control.extend({
  ...
  computeScaleAccordingPageCount: function () {
    let pageCount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
    pageCount *= 1;
    ...
    if (algorithm === AlgCoverArea) {
      computePageCount = function (scale) {
        ...
        let [rows, cols] = (0,_covering_js__WEBPACK_IMPORTED_MODULE_1__.areaRectanglesCount)(topLeft.subtract([pd.appx, pd.appx]), bottomRight.add([pd.appx, pd.appx]), pd.wpx - 2 * pd.ppx, pd.hpx - 2 * pd.ppx);
        return rows * cols;
      }.bind(this);
  ...
  calcPdfPages: function () {
    ...
    pd.images = [];
    let algorithm = this._rectanglesEvaluationMethod(this.area);
    let getRectangles = algorithm === AlgCoverArea ? this._getBoxRectangles.bind(this) : algorithm === AlgCoverPath ? this._getRouteRectangles.bind(this) : function () {
      return [];
    };
  ...
  calcImages: function (targetSizePx, paddingPx, extendToSquare) {
    ...
    let areaRect = new _covering_js__WEBPACK_IMPORTED_MODULE_1__.Rectangle(this.map.project(bounds.getNorthWest()), this.map.project(bounds.getSouthEast()));
    ...
    let rects = (0,_covering_js__WEBPACK_IMPORTED_MODULE_1__.coverAreaWithRectangles)(areaRect.topleft, areaRect.bottomright, areaRect.width, areaRect.height);
    if (rects.length !== 1) {
   ...
   * @private
   */
  _calcTargetZoomAndScale: function (targetScale) {
    let round = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Math.ceil;
    ...
    let maxZoom = this.maxZoom ? typeof this.maxZoom === "function" ? this.maxZoom() : this.maxZoom : this.map.getMaxZoom();
    let targetZoom = Math.min(maxZoom, round(this.map.getScaleZoom(targetScale, this.map.getZoom())));
   ...
   * @returns {boolean}
   */
  createImage: function (targetSizePx, paddingPx, extendToSquare) {
    let performScaleToTargetSize = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    if (this.status !== StatusReady) {
      return false;
    }
    ...
    document.addEventListener("pdf:imagesCompleted", function (data) {
      ...
      if (!performScaleToTargetSize) {
        ...
        (0,_image_processing__WEBPACK_IMPORTED_MODULE_2__.resizeImage)(data.detail.images[0], resultWidth, resultHeight).then(function (imageUrl) {
    ...
    for (let i = 0; i < pd.pagesToPrint.length; i++) {
      ...
      try {
        ...
        addText(pdf, pageFormat, Object.assign({
          text: `Page ${pd.pagesToPrint[i] + 1} of ${pd.pageCount}`
  ...
  _createImages: function (rects, indexes, targetZoom, imageFormat) {
    ...
    let filter = function (nodeElement) {
      ...
      if (nodeElement.matches) for (let s of this.options.excludeNodesWithCSS) {
    ...
    let generateImage = function (ev) {
      ...
      imageGenerator(this.map.getContainer(), options).then(function (data) {
        ...
        if (scale > 1 && data instanceof Blob) {
          (0,changedpi__WEBPACK_IMPORTED_MODULE_3__.changeDpiBlob)(data, this.baseImageDpi * this.pixelRatio).then(function (data) {
            images.push(data);
          ...
          data = (0,changedpi__WEBPACK_IMPORTED_MODULE_3__.changeDpiDataUrl)(data, this.baseImageDpi * this.pixelRatio);
        }
        images.push(data);
        document.dispatchEvent(new CustomEvent("pdf:startNextImage", {
          detail: {
  ...
  _getBoxRectangles: function (LObject, w, h, p, areaPadding, o) {
    ...
    const rects = (0,_covering_js__WEBPACK_IMPORTED_MODULE_1__.coverAreaWithRectangles)(topLeft, bottomRight, w - 2 * p, h - 2 * p);
    return rects;
  },
  _getRouteRectangles: function (LObject, w, h, p, ap, o) {
    ...
    const [rects, intersections] = (0,_covering_js__WEBPACK_IMPORTED_MODULE_1__.coverLineWithRectangles)(l, w - 2 * p, h - 2 * p, o === PageOrientationAuto);
  ...
  setPageCount: function () {
    let pages = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
...
leafletpdf = __webpack_exports__;
/******/ })()
;
//# sourceMappingURL=Leaflet.ImagePdf.min.js.map